...
// [UAA] - START - Compile() moved to Graphics/efkMat.Graphics.cpp
// It only translates a graph into an Effekseer::MaterialFile and preview
// bindings, with no GUI involvement, but living here made it unreachable
// from non-GUI tools because this translation unit pulls in imgui. It is now
// declared in efkMat.Graphics.h and shared with the headless material CLI.
// [UAA] - END
